...
public class AlertMessage {
	...
	public static final String MESSAGE_SOCKETEXCEPTION = "Network Busy.Please Try Again";
	...
	public void showMessage() {
		...
		if (condition.equals("acra_login")) {
			...
			acra_checkout(data);
		} else if (condition.equals("socket_checkout_store")) {

			socket_checkoutstore(data);
	...
	public void acra_checkout(String str) {
	...
	public void socket_checkoutstore(String str) {
