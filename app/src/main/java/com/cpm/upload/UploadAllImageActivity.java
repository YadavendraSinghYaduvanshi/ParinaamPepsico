		...
		protected String doInBackground(Void... params) {
			...
			try {
				...
				for (int i = 0; i < coverageBeanlist.size(); i++) {
					...
					if (!(coverageBeanlist.get(i).getReasonid()
						...
						if (coverageBeanlist.get(i).getImage() != null
							...
							if (new File("/mnt/sdcard/PepsicoImages/"
								...
								result = UploadImage(coverageBeanlist.get(i)
										.getImage());
						...
						// sod Data
						database.open();
						master_list = database.getSodDataMid(coverageBeanlist
								.get(i).getStoreId(), coverageBeanlist.get(i)
								.getMID());
						...
						for (int j = 0; j < master_list.size(); j++) {
							...
							if (master_list.get(j).getImg1() != null
									&& !master_list.get(j).getImg1().equals("")) {

								if (new File("/mnt/sdcard/PepsicoImages/"
										+ master_list.get(j).getImg1())
										.exists()) {

									result = UploadSODImage(master_list.get(j)
											.getImg1());
							...
							if (master_list.get(j).getImg2() != null
									&& !master_list.get(j).getImg2().equals("")) {
							...
							if (master_list.get(j).getImg3() != null
									&& !master_list.get(j).getImg3().equals("")) {
						...
						assetlist = database.getAssetData(coverageBeanlist.get(
								i).getMID());

						for (int j = 0; j < assetlist.size(); j++) {

							if (assetlist.get(j).getImage1() != null
									&& !assetlist.get(j).getImage1().equals("")) {

								if (new File("/mnt/sdcard/PepsicoImages/"
										+ assetlist.get(j).getImage1())
										.exists()) {

									result = UploadImage(assetlist.get(j)
											.getImage1());
							...
							if (assetlist.get(j).getImage2() != null
									&& !assetlist.get(j).getImage2().equals("")) {
							...
							if (assetlist.get(j).getImage3() != null
									&& !assetlist.get(j).getImage3().equals("")) {
						...
						for (int j = 0; j < cateogryimgdata.size(); j++) {
							...
							if (cateogryimgdata.get(j).getImageurl() != null
								...
								if (new File("/mnt/sdcard/PepsicoImages/"
									...
									result = UploadImage(cateogryimgdata.get(j)
											.getImageurl());
							...
							if (cateogryimgdata.get(j).getImageurl1() != null
									&& !cateogryimgdata.get(j).getImageurl1()
											.equals("")) {
							...
							if (cateogryimgdata.get(j).getImageurl2() != null
									&& !cateogryimgdata.get(j).getImageurl2()
											.equals("")) {
						...
						promo_list = database
								.gePromotionOtherMid(coverageBeanlist.get(i)
										.getMID());

						for (int j = 0; j < promo_list.size(); j++) {

							if (promo_list.get(j).getImage() != null
									&& !promo_list.get(j).getImage().equals("")) {
					...
					// SET COVERAGE STATUS
					String statusxml = "[DATA][USER_DATA][USER_ID]" + username
							+ "[/USER_ID][STORE_ID]"
