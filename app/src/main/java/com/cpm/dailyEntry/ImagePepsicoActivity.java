...
public class ImagePepsicoActivity extends Activity implements OnClickListener {
	int pos;
	String _UserId;
	String _Currentdate;
	String _intime;
	...
	public void onBackPressed() {
		...
		ImagePepsicoActivity.this.finish();
	}
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.geotag_camera1) {
			...
			_pathforcheck = store_id + "sod" + _UserId + getTime() + "image1"
					+ ".jpg";
		...
		if (v.getId() == R.id.geotag_camera2) {
			...
			_path1forcheck = store_id + "sod" + _UserId + getTime() + "image2"
					+ ".jpg";
		...
		if (v.getId() == R.id.geotag_camera3) {
			...
			_path2forcheck = store_id + "sod" + _UserId + getTime() + "image3"
					+ ".jpg";
		...
		case -1:
			...
			if (ImageUploadActivity.CheckGeotagImage(_pathforcheck)) {
				...
				try {
					...
					Toast.makeText(getApplicationContext(),
							"orientation z " + rotation, Toast.LENGTH_SHORT)
							.show();
