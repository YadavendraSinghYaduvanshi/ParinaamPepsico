...
public class SkuOtherActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sku_list = database.getSkuOtherCompetitorData(brand_id, store_id);
								...
								new DialogInterface.OnClickListener() {
									public void onClick(DialogInterface dialog,
										...
										database.InsertSosPepsiData(getMid(),
												store_id, sku_list,brand_id,CommonString.KEY_other);

										if (database.CheckBrandid(
												brand_id, store_id,CommonString.KEY_other) == 0) {
											database.InsertBrandCheck(
													brand_id, store_id,CommonString.KEY_other);
										}
