...
public class SkuTabActivity extends TabActivity

{
	...
	TabHost mTabHost;
	static SkuTabActivity instance;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		SkuTabActivity.this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE);
		pepsi = new Intent(this, SkuList.class);
		competitor = new Intent(this, SkuCompetitorActivity.class);
		setTabs();
		instance = this;
