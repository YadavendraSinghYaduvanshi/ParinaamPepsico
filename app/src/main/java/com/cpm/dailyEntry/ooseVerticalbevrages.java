...
import com.cpm.parinaampepsicoo.R.color;

public class ooseVerticalbevrages extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		sku_list = database.getSkuMappingData121_forbevrages(store_id);
		//sku_list.remove(0);
...
//
		...
		mKeyboard = new Keyboard(ooseVerticalbevrages.this, R.xml.keyboard);
	...
	holder.layoutcolor.setId(position);
	...
	public void onButtonClick(View v) {
		...
		case R.id.training_intellogo:
			...
			ooseVerticalbevrages.this.finish();
		...
		//		else {
				...
				//	if (condition()) {
						AlertDialog.Builder builder = new AlertDialog.Builder(
								ooseVerticalbevrages.this);
						alert = builder.create();

						builder.setMessage("Do you want to save the data for Bevrages")
								.setCancelable(false)
