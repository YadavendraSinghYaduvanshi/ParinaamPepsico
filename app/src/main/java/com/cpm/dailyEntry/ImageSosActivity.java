...
public class ImageSosActivity extends Activity implements OnClickListener {
	int pos;
	String _UserId;
	String _Currentdate;
	String _intime;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Intent i = getIntent();
		category_id = i.getStringExtra(CommonString.KEY_CATEGORY_ID);
	...
	public void onBackPressed() {
		...
		Intent intent = new Intent(ImageSosActivity.this,
				ShareOfShelfActivity.class);
		intent.putExtra(CommonString.KEY_IMAGE_PATH1, imgpath1);
		intent.putExtra(CommonString.KEY_IMAGE_PATH2, imgpath2);
		intent.putExtra(CommonString.KEY_IMAGE_PATH3, imgpath3);
		setResult(RESULT_OK, intent);
		ImageSosActivity.this.finish();
	...
	public void onClick(View v) {
		...
		if (v.getId() == R.id.geotag_camera1) {
			...
			_pathforcheck = store_id + "sos" + _UserId + getTime() + "image1"
					+ ".jpg";
		...
		if (v.getId() == R.id.geotag_camera2) {
			...
			_path1forcheck = store_id + "sos" + _UserId + getTime() + "image2"
					+ ".jpg";
		...
		if (v.getId() == R.id.geotag_camera3) {
			...
			_path2forcheck = store_id + "sos" + _UserId + getTime() + "image3"
					+ ".jpg";
						...
						.setPositiveButton("OK",
								new DialogInterface.OnClickListener() {
									public void onClick(DialogInterface dialog,
										...
										if (status) {
											database.UpdateSosImagesData(
													category_id, store_id,
													image1, image2, image3);
										} else {
											database.InsertSosImagesData(
													category_id, store_id,
													image1, image2, image3);
										}
