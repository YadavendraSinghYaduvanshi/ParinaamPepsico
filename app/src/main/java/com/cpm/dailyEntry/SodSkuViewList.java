...
public class SodSkuViewList extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.sod_skulist);
	...
	private static class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			ViewHolder holder;
			if (convertView == null) {
				convertView = mInflater.inflate(R.layout.sodlist, null);
			...
			holder.dom1.setText(sku_list.get(position).getDom1().toString());
			holder.dom2.setText(sku_list.get(position).getDom2().toString());
			holder.dom3.setText(sku_list.get(position).getDom3().toString());

			return convertView;
		}

		static class ViewHolder {
			TextView sku, dom1, dom2, dom3, stock, faceup;
