...
public class PromotinPepsiActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		promo_list = database.gePromotionDownloaded(store_id);

		for (int i = 0; i < promo_list.size(); i++) {

			promo_list.get(i).setCamera("NO");
			promo_list.get(i).setImage("");
			promo_list.get(i).setAvailable("NO");
			promo_list.get(i).setRemarks("");
					...
					.setOnLongClickListener(new View.OnLongClickListener() {
						...
						public boolean onLongClick(View v) {
							...
							Intent intent = new Intent(
									(PromotinPepsiActivity) mcontext,
	...
	public void onButtonClick(View v) {
		...
		case R.id.training_intellogo:
			...
			PromotinPepsiActivity.this.finish();
			break;
						...
						.setPositiveButton("OK",
								new DialogInterface.OnClickListener() {
									public void onClick(DialogInterface dialog,
										...
										mposition = -1;
										database.open();
										database.InsertPromotionData(getMid(),
												store_id, promo_list);
	...
	public boolean validate_data() {
		...
		for (int i = 0; i < promo_list.size(); i++) {
			if (promo_list.get(i).getAvailable().equalsIgnoreCase("NO")||promo_list.get(i).getImage().isEmpty()) {
		...
		/*	if (promo_list.get(i).getAvailable().equalsIgnoreCase("YES")) {
			...
			/*
			 * if (result) { if
			 * (!promo_list.get(i).getRemarks().equalsIgnoreCase("")) { result =
			 * false; break; } }
			 */
		}
		return result;
